...
parser.add_argument("--save_analyseformat", action="store_true", help="(optional) Save the segmentation in Analyse format.(Updated 24/04/24 by Ziyang)")
...
if args['save_analyseformat']:
    ...
    print('Saving the relabeled segmentation in Analyse format.')
if args['save_brain']:
