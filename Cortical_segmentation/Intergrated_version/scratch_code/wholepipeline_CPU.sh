...
#SBATCH --job-name=synthseg_wholepipeline_CPU
#SBATCH --time=20:00:00  # Adjusted job time, if needed
...
python /users/zxu/synthseg/SynthSeg/scripts/commands/SynthSeg_predict_ukb.py --i /users/zxu/synthseg/batch_move_test/input --o /users/zxu/synthseg/batch_move_test/output --parc --robust --cpu --threads 30 --resolutionconversion --relabel --label_correction --qc /users/zxu/synthseg/batch_move_test/output/qc.csv 
