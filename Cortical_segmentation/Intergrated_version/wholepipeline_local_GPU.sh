...
python /users/zxu/synthseg/SynthSeg/scripts/commands/SynthSeg_predict_ukb.py --i /users/zxu/ukb_data/input_file_paths.txt --o /users/zxu/ukb_data/output_file_paths.txt --parc --robust --resolutionconversion --relabel --label_correction --qc /users/zxu/ukb_data/qc_file_paths.txt
